...
// To conserve space all of these functions are inline functions.
// If you want practice move the implementation of these functions out of class
// declaration and put them in a separate file.  Compile it and run it.  
#include <iostream>
using namespace std;
